...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    password: "",
    confirmPassword: "",
    role: "", // Tetap "" agar placeholder "Select your role" muncul
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Body-to-submit sudah benar (termasuk phone, dob, gender)
      const bodyToSubmit = {
        ...
        role: formData.role, // Ini akan mengirim 'admin' atau 'member'
      };
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#F0F4F8] py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-xl space-y-8 rounded-xl bg-white p-10 shadow-lg">
        {/* ... (kode untuk Judul, Full Name, Email, Phone, DOB, Gender, Password) ... */}
        {/* Saya akan singkat bagian yang tidak berubah */}
            ...
            <div className="sm:col-span-2">
              ...
              <div className="relative mt-1">
                ...
                >
                  ...
                  {/* Ganti value agar sesuai ENUM di database */}
